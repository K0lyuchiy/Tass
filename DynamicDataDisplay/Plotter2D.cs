...
namespace Microsoft.Research.DynamicDataDisplay
{
	...
	public class Plotter2D : Plotter
	{
        ...
        {
            //((ChartPlotter)target).evt.OnSomeEvent();
            //viewport.FitToView();
        }

        // kda 06.05.2011
        public void PlaceMarkerTx2()
        {
            //((ChartPlotter)target).evt.OnSomeEvent();
            //viewport.FitToView();
        }
        ...
        // kda 06.06.2011
        public void PlaceTargetMarker()
        {
            //((ChartPlotter)target).evt1.OnSomeEvent();
            //viewport.FitToView();
        }

        // kda 04.07.2011
        public void PlaceReceiverMarker()
        {
            //((ChartPlotter)target).evt1.OnSomeEvent();
            //viewport.FitToView();
        }
        ...
        // kda 04.07.2011
        public void PlaceReceiver2Marker()
        {
            //((ChartPlotter)target).evt1.OnSomeEvent();
            //viewport.FitToView();
        }
        ...
        // kda 04.07.2011
        public void PlaceReceiver3Marker()
        {
            //((ChartPlotter)target).evt1.OnSomeEvent();
            //viewport.FitToView();
        }
        ...
        // kda 04.07.2011
        public void PlaceReceiver4Marker()
        {
            //((ChartPlotter)target).evt1.OnSomeEvent();
            //viewport.FitToView();
        }
